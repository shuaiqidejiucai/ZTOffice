#ifndef PST_ROUNDTRIPCOLORMAPPING12ATOM_H
#define PST_ROUNDTRIPCOLORMAPPING12ATOM_H

#include "pst_base.h"

class PSTParser_EXPORT PST_RoundTripColorMapping12Atom : public PST_Base
{
public:
